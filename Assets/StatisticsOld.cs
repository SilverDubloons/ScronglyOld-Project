...
public class StatisticsOld : MonoBehaviour
{
	[DllImport("__Internal")]
    private static extern void JS_FileSystem_Sync();
	
	public static StatisticsOld instance;
...
/* 		for(int i = 0; i < data.Length; i++)
		...
		for(int i = 0; i < (data.Length - 34) / 8; i++)
		{
			bestHandCards.Add(new SavedCard(bool.Parse(data[35 + i * 8]), int.Parse(data[36 + i * 8]), int.Parse(data[37 + i * 8]), int.Parse(data[38 + i * 8]), float.Parse(data[39 + i * 8]), bool.Parse(data[40 + i * 8]), float.Parse(data[41 + i * 8]), bool.Parse(data[42 + i * 8])));
		}
	...
	public class RunInformation
	{
		...
		public int deckUsed;
		public int[] handTypesPlayed = new int[18];
	...
	public class SavedCard
	{
		...
		public SavedCard(bool standardCard, int nonStandardCardNumber, int rankInt, int suitInt, float cardValue, bool cardValueHasBeenChanged, float cardMultiplier, bool cardMultiplierHasChanged)
		{
	...
	public void UpdateBestHand(List<CardScript> hand, RunInformation runInformation)
	{
		...
		{
			savedCards.Add(new SavedCard(hand[i].standardCard, hand[i].nonStandardCardNumber, hand[i].rankInt, hand[i].suitInt, hand[i].cardValue, hand[i].cardValueHasBeenChanged, hand[i].cardMultiplier, hand[i].cardMultiplierHasChanged));
		}
